...
static GLint project(GLdouble objx, GLdouble objy, GLdouble objz,
    ...
    GLdouble * winx, GLdouble * winy, double * winz)
{
    double in[4], out[4];
...
namespace Enki
{
	...
	*/
	...
	void ViewerWidget::renderText(double x, double y, double z, const QString &str, const QFont &font) {
		...
		renderText(static_cast<int>(textPosX), static_cast<int>(textPosY), str, font);
	}
