...
#define PROX_RAYS 5
#define PROX_APERTURE 30
#define PROX_RANGE 28
#define PROX_M 4505
#define PROX_C 73
#define PROX_X0 0.03
#define PROX_NOISE 2.87
#define PROX_MIN_VALUE 1000
...
namespace Enki
{
	...
	Thymio2::Thymio2() :
		...
		infraredSensor0(this, Vector(6.2, 4.85),   3.4, 0.69813,  PROX_RANGE, PROX_M, PROX_X0, PROX_C, PROX_NOISE, PROX_RAYS, PROX_APERTURE, PROX_MIN_VALUE),
		infraredSensor1(this, Vector(7.5, 2.55),   3.4, 0.34906,  PROX_RANGE, PROX_M, PROX_X0, PROX_C, PROX_NOISE, PROX_RAYS, PROX_APERTURE, PROX_MIN_VALUE),
		infraredSensor2(this, Vector(7.95, 0.0),   3.4, 0.0,      PROX_RANGE, PROX_M, PROX_X0, PROX_C, PROX_NOISE, PROX_RAYS, PROX_APERTURE, PROX_MIN_VALUE),
		infraredSensor3(this, Vector(7.5, -2.55),  3.4, -0.34906, PROX_RANGE, PROX_M, PROX_X0, PROX_C, PROX_NOISE, PROX_RAYS, PROX_APERTURE, PROX_MIN_VALUE),
		infraredSensor4(this, Vector(6.2, -4.85),  3.4, -0.69813, PROX_RANGE, PROX_M, PROX_X0, PROX_C, PROX_NOISE, PROX_RAYS, PROX_APERTURE, PROX_MIN_VALUE),
		infraredSensor5(this, Vector(-2.95, 2.95), 3.4, -M_PI,    PROX_RANGE, PROX_M, PROX_X0, PROX_C, PROX_NOISE, PROX_RAYS, PROX_APERTURE, PROX_MIN_VALUE),
		infraredSensor6(this, Vector(-2.95, -2.95),3.4, -M_PI,    PROX_RANGE, PROX_M, PROX_X0, PROX_C, PROX_NOISE, PROX_RAYS, PROX_APERTURE, PROX_MIN_VALUE),
		irComm(this, COMM_RANGE, 0.1, COMM_RECEIVER_APERTURE, COMM_M, COMM_X0, COMM_C, COMM_NOISE, COMM_MIN_VALUE, COMM_KE, COMM_KR),
		...
		groundSensor1(this, Vector(7.2, -1.15), 0.44, 9, 884, 60, 0.4, 10)
	{
		...
		addGlobalInteraction(&irComm);
		irComm.add_sensor(&infraredSensor0);
		irComm.add_sensor(&infraredSensor1);
		irComm.add_sensor(&infraredSensor2);
		irComm.add_sensor(&infraredSensor3);
		irComm.add_sensor(&infraredSensor4);
		irComm.add_sensor(&infraredSensor5);
		irComm.add_sensor(&infraredSensor6);
