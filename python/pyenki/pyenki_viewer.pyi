...
def run_in_viewer(world: World, /, fps: SupportsFloat = ..., time_step: SupportsFloat = ..., factor: SupportsFloat = ..., physics_oversampling: int = ..., callback: collections.abc.Callable[[World], None] | None = ..., termination: collections.abc.Callable[[World], bool] | None = ..., helpers: bool = ..., walls_height: SupportsFloat = ..., duration: SupportsFloat = ..., camera_position: VectorLike = ..., camera_altitude: SupportsFloat = ..., camera_yaw: SupportsFloat = ..., camera_pitch: SupportsFloat = ..., camera_is_ortho: bool = ..., camera_reset: bool = ...) -> None: ...
...
class WorldView:
    ...
    is_tracking: bool
    world: World | None
    callback: collections.abc.Callable[[World], None] | None
    physics_oversampling: int
